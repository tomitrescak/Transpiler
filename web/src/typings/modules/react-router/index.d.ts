...
declare module '~react-router/react-router' {
  ...
  module ReactRouter {
    ...
    export interface IRouterProps {
       ...
       */
      stringifyQuery?(queryObject: Object): any;
    ...
    export interface IRouter {
       ...
       */
      push(pathOrLoc: LocationDescriptor): any;
       ...
       * @param {Query} query
       */
      createPath(pathOrLoc: LocationDescriptor, query: Query): any;
       ...
       * @param {Query} query
       */
      createHref(pathOrLoc: LocationDescriptor, query: Query): any;
    ...
    export interface PlainRoute extends IRouteProps {
       ...
       */
      getChildRoutes?(location: Location, callback: (err: Error, routes: PlainRoute[]) => void): any;
       ...
       */
      getIndexRoute(location: Location, callback: (err: Error, route: PlainRoute) => void): any;
    }
    ...
    export interface IIndexRouteProps {
       ...
       */
      getComponent?(location: Location, callback: (error: Error, component: ReactComponent<any>) => void): any;
       ...
       */
      getComponent?(location: Location, callback: (error: Error, components: { [name: string]: ReactComponent<any> }) => void): any;
       ...
       * @param {() => void} [callback]
       */
      onEnter?(nextState: any, replace: (location: LocationDescriptor) => void, callback?: () => void): any;
     ...
     */
    export function match({routes: RouteConfig}: any, callback: (error: Error, redirectLocation: Location, renderProps: Object) => void): any;
